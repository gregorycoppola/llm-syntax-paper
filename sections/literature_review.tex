...
\citet{zettlemoyer2005} and \citet{kwiatkowski2010} showed how probabilistic categorial grammars (CCG) could be induced from logical forms, establishing a formal connection between syntactic and semantic representations. \citet{bos2004} demonstrated that CCG parsing could provide wide-coverage semantic representations, while \citet{liang2011} introduced dependency-based compositional semantics as an alternative approach.
