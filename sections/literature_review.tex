...
The relationship between syntactic and semantic parsing has been a central theme in natural language processing research. Early work by \citet{zelle1996} and \citet{wong2007} demonstrated how syntactic structure could be leveraged for semantic interpretation, particularly in database query parsing and lambda calculus-based semantic representations. This line of research evolved through several key developments:

\citet{zettlemoyer2005} and \citet{kwiatkowski2010} showed how probabilistic categorial grammars (CCG) could be induced from logical forms, establishing a formal connection between syntactic and semantic representations. \citet{bos2004} demonstrated that CCG parsing could provide wide-coverage semantic representations, while \citet{liang2013learning} introduced dependency-based compositional semantics as an alternative approach.

More recent work has explored interactive and grounded approaches to semantic parsing. \citet{clarke2010} introduced a framework for driving semantic parsing from world responses, while \citet{artzi2011} showed how semantic parsers could be bootstrapped from conversations. \citet{chen2008} and \citet{branavan2009} demonstrated how semantic parsing could be applied to grounded language tasks like sportscasting and instruction following.
