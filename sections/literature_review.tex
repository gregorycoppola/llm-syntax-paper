...
\citet{jiao2024gradable} introduced a novel approach to evaluating LLM outputs using gradable criteria, demonstrating how ChatGPT can provide nuanced assessments of linguistic quality. Their work suggests that LLMs can not only perform linguistic tasks but also evaluate them with human-like granularity.
...
Jiao et al. (2024) & ChatGPT & Evaluation & Gradable & Novel evaluation framework \\
