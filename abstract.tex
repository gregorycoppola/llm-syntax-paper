\begin{abstract}
    ...
    We propose that these results constitute that full open-domain semantic parsing may well be possible, given the right {\em agentic} control flow---aka. sequence of calls to LLM's and other tools.
\end{abstract}